...
- `env` (String) The Coralogix API environment. can be one of ["APAC2" "EUROPE1" "EUROPE2" "USA1" "USA2" "APAC1"]. environment variable 'CORALOGIX_ENV' can be defined instead.
