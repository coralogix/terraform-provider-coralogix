...
- `env` (String) The Coralogix API environment. can be one of ["US2" "AP2" "APAC3" "AP3" "EUROPE1" "APAC1" "AP1" "US1" "APAC2" "EUROPE2" "EU2" "EU1" "USA1" "USA2"]. environment variable 'CORALOGIX_ENV' can be defined instead.
