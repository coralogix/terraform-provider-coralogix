...
- `arithmetic_operator` (String) The arithmetic operator to use on the alert. can be one of ["Min" "Max" "Sum" "Count" "Percentile" "Avg"]
...
- `time_window` (String) The bounded time frame for the threshold to be occurred within, to trigger the alert. Can be one of ["2H" "6H" "1Min" "10Min" "15Min" "20Min" "30Min" "1H" "12H" "5Min" "4H" "24H"]
...
- `severities` (Set of String) An array of log severities that we interested in. Can be one of ["Info" "Warning" "Error" "Critical" "Debug" "Verbose"]
...
- `time_window` (String) The bounded time frame for the threshold to be occurred within, to trigger the alert. Can be one of ["24H" "48H" "72H" "1W" "1Month" "2Month" "3Month" "12H"]
...
- `time_window` (String) The bounded time frame for the threshold to be occurred within, to trigger the alert. Can be one of ["10Min" "15Min" "30Min" "1H" "4H" "6H" "12H" "5Min" "20Min" "2H" "24H" "36H"]
...
- `time_window` (String) The bounded time frame for the threshold to be occurred within, to trigger the alert. Can be one of ["10Min" "15Min" "20Min" "30Min" "4H" "12H" "1Min" "5Min" "1H" "2H" "6H" "24H"]
