...
- `unit` (String) The unit of the chart. Can be one of microseconds, kbytes, gbytes, mibytes, euro, usd, seconds, euro_cents, usd_cents, bytes, gibytes, unspecified, milliseconds, mbytes, bytes_iec, kibytes.
...
- `aggregation_type` (String) The type of the aggregation. When the aggregation type is `metrics`, can be one of ["avg" "sum" "percentile_99" "percentile_95" "percentile_50" "unspecified" "min" "max"]. When the aggregation type is `dimension`, can be one of ["unspecified" "unique_count" "error_count"].
...
- `query` (Attributes) (see [below for nested schema](#nestedatt--layout--sections--rows--id--definition--pie_chart--query))
- `unit` (String) The unit of the gauge. Can be one of ["milliseconds" "seconds" "kbytes" "bytes_iec" "mibytes" "euro" "bytes" "kibytes" "euro_cents" "microseconds" "mbytes" "gibytes" "none" "percent" "gbytes" "usd_cents" "usd"].
...
- `unit` (String) The unit. Valid values are: microseconds, kbytes, gbytes, mibytes, euro, usd, seconds, euro_cents, usd_cents, bytes, gibytes, unspecified, milliseconds, mbytes, bytes_iec, kibytes.
