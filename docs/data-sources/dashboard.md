...
- `unit` (String) The unit of the chart. Can be one of unspecified, milliseconds, mbytes, kibytes, seconds, euro_cents, microseconds, bytes, bytes_iec, gibytes, euro, usd, kbytes, gbytes, mibytes, usd_cents.
...
- `aggregation_type` (String) The type of the aggregation. When the aggregation type is `metrics`, can be one of ["sum" "percentile_99" "percentile_95" "percentile_50" "unspecified" "min" "max" "avg"]. When the aggregation type is `dimension`, can be one of ["unspecified" "unique_count" "error_count"].
...
- `unit` (String) The unit of the gauge. Can be one of ["percent" "gbytes" "bytes_iec" "kibytes" "gibytes" "none" "kbytes" "mibytes" "euro" "usd_cents" "seconds" "mbytes" "euro_cents" "usd" "microseconds" "bytes" "milliseconds"].
...
- `unit` (String) The unit. Valid values are: unspecified, milliseconds, mbytes, kibytes, seconds, euro_cents, microseconds, bytes, bytes_iec, gibytes, euro, usd, kbytes, gbytes, mibytes, usd_cents.
