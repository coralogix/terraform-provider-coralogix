...
// APIClient manages communication with the Fake Boards API API v1
...
type APIClient struct {
	...
	FakeBoardsServiceAPI *FakeBoardsServiceAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.FakeBoardsServiceAPI = (*FakeBoardsServiceAPIService)(&c.common)
