...
// APIClient manages communication with the Fake Rules API API v1
...
type APIClient struct {
	...
	FakeRulesServiceAPI *FakeRulesServiceAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.FakeRulesServiceAPI = (*FakeRulesServiceAPIService)(&c.common)
