		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.retriggering_period.minutes", "1"),
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.notify_on", "Triggered and Resolved"),
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.recipients.#", "1"),
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.recipients.*", "example@coralogix.com"),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.retriggering_period.minutes", "1"),
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.notify_on", "Triggered Only"),
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.recipients.#", "1"),
					resource.TestCheckResourceAttr(alertResourceName, "notification_group.0.simple_target_settings.0.recipients.*", "example@coralogix.com"),
					resource.TestCheckResourceAttr(alertResourceName, "incidents_settings.notify_on", "Triggered and Resolved"),
