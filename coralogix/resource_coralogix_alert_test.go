		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(alertResourceName, "schedule.active_on.end_time.hours", "20"),
					resource.TestCheckResourceAttr(alertResourceName, "schedule.active_on.end_time.minutes", "30"),
					resource.TestCheckTypeSetElemNestedAttrs(alertResourceName, "type_definition.logs_more_than_usual.lucene_filter.application_name.*",
						map[string]string{
							"operation": "OR",
							"value":     "nginx",
						},
					),
					resource.TestCheckTypeSetElemNestedAttrs(alertResourceName, "type_definition.logs_more_than_usual.lucene_filter.label_filters.subsystem_name.*",
						map[string]string{
							"operation": "OR",
							"value":     "subsystem-name",
						},
					),
					resource.TestCheckTypeSetElemAttr(alertResourceName, "type_definition.logs_more_than_usual.lucene_filter.label_filters.severities.*", "Warning"),
					resource.TestCheckResourceAttr(alertResourceName, "type_definition.logs_more_than_usual.lucene_filter.label_filters.lucene_query", "message:\"error\""),
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(alertResourceName, "type_definition.logs_more_than_usual.lucene_filter.label_filters.application_name.*",
						map[string]string{
							"operation": "OR",
							"value":     "nginx",
						},
					...
					resource.TestCheckTypeSetElemAttr(alertResourceName, "type_definition.logs_more_than_usual.lucene_filter.label_filters.severities.*", "Warning"),
					resource.TestCheckTypeSetElemAttr(alertResourceName, "type_definition.logs_more_than_usual.lucene_filter.label_filters.severities.*", "Error"),
