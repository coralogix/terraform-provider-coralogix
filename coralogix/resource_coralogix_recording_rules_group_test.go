		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(recordingRulesGroupsResourceName, "groups.0.name", "Foo 2"),
					resource.TestCheckResourceAttr(recordingRulesGroupsResourceName, "groups.0.interval", "180"),
					resource.TestCheckResourceAttr(recordingRulesGroupsResourceName, "groups.0.rules.#", "2"),
					resource.TestCheckResourceAttr(recordingRulesGroupsResourceName, "groups.0.rules.%", ""),
					resource.TestCheckResourceAttr(recordingRulesGroupsResourceName, "groups.0.rules.%", ""),
				),
			},
		},
