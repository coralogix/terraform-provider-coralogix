		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(events2metricResourceName, "metric_fields.geo_point.aggregations.avg",
						map[string]string{
							"target_metric_name": "cx_avg",
							"enable":             "true"},
					),
					resource.TestCheckTypeSetElemNestedAttrs(events2metricResourceName, "metric_fields.geo_point.aggregations.count",
						map[string]string{
							"target_metric_name": "cx_count",
							"enable":             "true"},
					),
					resource.TestCheckTypeSetElemNestedAttrs(events2metricResourceName, "metric_fields.geo_point.aggregations.histogram",
						map[string]string{
							"target_metric_name": "cx_bucket",
							"enable":             "true"},
					),
					resource.TestCheckTypeSetElemNestedAttrs(events2metricResourceName, "metric_fields.geo_point.aggregations.max",
						map[string]string{
					...
					//resource.TestCheckTypeSetElemNestedAttrs(events2metricResourceName, "metric_fields.method.source_field.aggregations.*",
					//	map[string]string{
					//		"avg":       `{ "target_metric_name": "cx_avg", "enable": "true" }`,
					//		"count":     `{ "target_metric_name": "cx_count", "enable": "true" }`,
					//		"histogram": `{ "target_metric_name": "cx_bucket", "enable": "false" }`,
					//		"max":       `{ "target_metric_name": "cx_max", "enable": "true" }`,
					//		"min":       `{ "target_metric_name": "cx_min"", "enable": "true" }`,
					//		"sum":       `{ "target_metric_name": "cx_sum", "enable": "true" }`,
					//		"samples":   `{ "enable": "false", target_metric_name": "cx_value", "type": "Max" }`,
					//	}),
