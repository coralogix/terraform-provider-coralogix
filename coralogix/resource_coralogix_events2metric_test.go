		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckTypeSetElemNestedAttrs(events2metricResourceName, "metric_fields.geo_point.aggregations.*",
						map[string]string{
							"avg":       `{ "target_metric_name": "cx_avg", "enable": "true" }`,
							"count":     `{ "target_metric_name": "cx_count", "enable": "true" }`,
							"histogram": `{ "target_metric_name": "cx_bucket", "enable": "true" }`,
							...
							"samples":   `{ "enable": "true", target_metric_name": "cx_value", "type": "Max" }`,
						}),
