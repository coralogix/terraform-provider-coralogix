		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(dashboardResourceName, "variables.0.definition.0.multi_select.0.selected.0", "1"),
					resource.TestCheckResourceAttr(dashboardResourceName, "variables.0.definition.0.multi_select.0.selected.1", "2"),
					resource.TestCheckResourceAttr(dashboardResourceName, "variables.0.definition.0.multi_select.0.selected.2", "3"),
					resource.TestCheckResourceAttr(dashboardResourceName, "variables.0.definition.0.multi_select.0.source.0.constant_list.0.values.0", "1"),
					resource.TestCheckResourceAttr(dashboardResourceName, "variables.0.definition.0.multi_select.0.source.0.constant_list.0.values.1", "2"),
					resource.TestCheckResourceAttr(dashboardResourceName, "variables.0.definition.0.multi_select.0.source.0.constant_list.0.values.2", "3"),
				),
			},
			{
