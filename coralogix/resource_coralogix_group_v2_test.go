		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(groupResourceName, "roles.#", "1"),
					resource.TestCheckResourceAttr(groupResourceName, "roles.0.id", "1"),
					resource.TestCheckResourceAttr(groupResourceName, "scope.#", "1"),
					resource.TestCheckResourceAttr(groupResourceName, "scope.0.display_name", "ExampleScope"),
					resource.TestCheckResourceAttr(groupResourceName, "scope.0.default_expression", "<v1>true"),
					resource.TestCheckResourceAttr(groupResourceName, "scope.0.filters.#", "1"),
					resource.TestCheckResourceAttr(groupResourceName, "scope.0.filters.0.entity_type", "logs"),
					resource.TestCheckResourceAttr(groupResourceName, "scope.0.filters.0.expression", "<v1>(subsystemName == 'purchases') || (subsystemName == 'signups')"),
				),
			},
			{
