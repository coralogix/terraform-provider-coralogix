		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.#", "1"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.0.subsystem.#", "2"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.0.subsystem.0.filter_type", "exact"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.0.subsystem.0.term", "purchases"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.0.subsystem.1.filter_type", "exact"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.0.subsystem.1.term", "signups"),
				),
			},
			{
