		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.subsystem.0.filter_type", "exact"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.subsystem.0.term", "purchases"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.subsystem.1.filter_type", "exact"),
					resource.TestCheckResourceAttr(groupV2ResourceName, "scope.filters.subsystem.1.term", "signups"),
				),
			},
			{
