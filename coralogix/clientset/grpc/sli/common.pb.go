...
var file_com_coralogix_catalog_v1_common_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_com_coralogix_catalog_v1_common_proto_goTypes = []interface{}{
...
var file_com_coralogix_catalog_v1_common_proto_depIdxs = []int32{
	1, // 0: com.coralogix.catalog.v1.TimeRange.start:type_name -> google.protobuf.Int64Value
	1, // 1: com.coralogix.catalog.v1.TimeRange.end:type_name -> google.protobuf.Int64Value
...
func file_com_coralogix_catalog_v1_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_catalog_v1_common_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
