...
func (x *MetricMoreThanUsualTypeDefinition) GetMetricFilter() *MetricFilter {
	if x != nil {
...
var file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_more_than_usual_type_definition_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_more_than_usual_type_definition_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_alert_def_type_definition_metric_metric_more_than_usual_type_definition_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
