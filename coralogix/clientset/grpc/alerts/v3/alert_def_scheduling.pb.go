...
var file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x2e, 0x76, 0x33, 0x22, 0xe4, 0x01, 0x0a, 0x10, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69,
	...
	0x4e, 0x44, 0x41, 0x59, 0x10, 0x06, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_com_coralogixapis_alerts_v3_alert_def_scheduling_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
