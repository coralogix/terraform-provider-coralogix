...
var file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_rawDesc = []byte{
	...
	0x45, 0x4e, 0x54, 0x5f, 0x48, 0x49, 0x44, 0x44, 0x45, 0x4e, 0x10, 0x04, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_goTypes = []any{
	...
	(Legend_LegendPlacement)(0),  // 1: com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.LegendPlacement
	(*Legend)(nil),               // 2: com.coralogixapis.dashboards.v1.ast.widgets.common.Legend
...
var file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_depIdxs = []int32{
	3, // 0: com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.is_visible:type_name -> google.protobuf.BoolValue
	...
	3, // 2: com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.group_by_query:type_name -> google.protobuf.BoolValue
	1, // 3: com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.placement:type_name -> com.coralogixapis.dashboards.v1.ast.widgets.common.Legend.LegendPlacement
...
func file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_dashboards_v1_ast_widgets_common_legend_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Legend); i {
			case 0:
				return &v.state
			case 1:
