...
var file_com_coralogixapis_dashboards_v1_ast_folder_path_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_dashboards_v1_ast_folder_path_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_dashboards_v1_ast_folder_path_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
