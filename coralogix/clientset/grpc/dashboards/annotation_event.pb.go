...
func (x *AnnotationEvent) GetInstant() *AnnotationEvent_Instant {
	if x, ok := x.GetValue().(*AnnotationEvent_Instant_); ok {
		return x.Instant
	}
	return nil
}
...
func (x *AnnotationEvent) GetRange() *AnnotationEvent_Range {
	if x, ok := x.GetValue().(*AnnotationEvent_Range_); ok {
		return x.Range
	}
	return nil
}
...
var file_com_coralogixapis_dashboards_v1_common_annotation_event_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_dashboards_v1_common_annotation_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_dashboards_v1_common_annotation_event_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AnnotationEvent); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_dashboards_v1_common_annotation_event_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AnnotationEvent_Instant); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_dashboards_v1_common_annotation_event_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AnnotationEvent_Range); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_com_coralogixapis_dashboards_v1_common_annotation_event_proto_msgTypes[0].OneofWrappers = []interface{}{
