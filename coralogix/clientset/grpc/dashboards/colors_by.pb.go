...
func file_com_coralogixapis_dashboards_v1_ast_widgets_common_colors_by_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_dashboards_v1_ast_widgets_common_colors_by_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_dashboards_v1_ast_widgets_common_colors_by_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_dashboards_v1_ast_widgets_common_colors_by_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_dashboards_v1_ast_widgets_common_colors_by_proto_msgTypes[3].Exporter = func(v any, i int) any {
