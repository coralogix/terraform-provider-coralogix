...
func file_com_coralogixapis_dashboards_v1_common_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_dashboards_v1_common_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Group); i {
			case 0:
				return &v.state
			case 1:
		...
		file_com_coralogixapis_dashboards_v1_common_group_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_com_coralogixapis_dashboards_v1_common_group_proto_msgTypes[2].Exporter = func(v any, i int) any {
