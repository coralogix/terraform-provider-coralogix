...
var file_com_coralogix_rules_v1_rule_group_proto_rawDesc = []byte{
	...
	0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x42, 0x04, 0x5a,
...
func file_com_coralogix_rules_v1_rule_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_com_coralogix_rules_v1_rule_group_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TeamId); i {
			case 0:
				return &v.state
			case 1:
