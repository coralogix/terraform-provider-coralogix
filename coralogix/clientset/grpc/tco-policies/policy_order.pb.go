...
var file_com_coralogix_quota_v1_policy_order_proto_goTypes = []interface{}{
...
func file_com_coralogix_quota_v1_policy_order_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_quota_v1_policy_order_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PolicyOrder); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
