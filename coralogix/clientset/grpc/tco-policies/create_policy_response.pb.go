...
var file_com_coralogix_quota_v1_create_policy_response_proto_goTypes = []interface{}{
...
func file_com_coralogix_quota_v1_create_policy_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogix_quota_v1_create_policy_response_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
