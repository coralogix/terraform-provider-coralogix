...
var file_com_coralogixapis_apm_services_v1_apm_service_proto_rawDesc = []byte{
	...
	0x68, 0x6e, 0x6f, 0x6c, 0x6f, 0x67, 0x79, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62, 0x06, 0x70,
...
var file_com_coralogixapis_apm_services_v1_apm_service_proto_goTypes = []interface{}{
...
func file_com_coralogixapis_apm_services_v1_apm_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_com_coralogixapis_apm_services_v1_apm_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SloStatusCount); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_com_coralogixapis_apm_services_v1_apm_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ApmService); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
