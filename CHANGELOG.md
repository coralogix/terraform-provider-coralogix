...
- FIX: A configuration that resolves to two visualizations after apply, or a `min_max` that resolves to both its alternatives, is now reported instead of silently keeping one and discarding the other.
