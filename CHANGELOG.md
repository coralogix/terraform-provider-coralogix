...
- FIX: A list that is unknown while planning and resolves to empty during apply is now rejected with a message naming the attribute, instead of failing the apply with an inconsistent-result error.
