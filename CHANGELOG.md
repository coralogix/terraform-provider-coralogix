...
- DOCS: Clarify the `description` attribute documentation — it now explains the field is an optional free-text note displayed alongside the alert definition in the Coralogix UI, replacing the terse "Alert description." text.
