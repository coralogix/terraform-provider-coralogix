...
var _ datasource.DataSourceWithConfigure = &TCOPoliciesRumDataSource{}

func NewTCOPoliciesRumDataSource() datasource.DataSource {
	return &TCOPoliciesRumDataSource{}
}

type TCOPoliciesRumDataSource struct {
	client *tcoPolicys.PoliciesServiceAPIService
}

func (d *TCOPoliciesRumDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_tco_policies_rum"
}

func (d *TCOPoliciesRumDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *TCOPoliciesRumDataSource) Schema(ctx context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	var r TCOPoliciesRumResource
...
func (d *TCOPoliciesRumDataSource) Read(ctx context.Context, _ datasource.ReadRequest, resp *datasource.ReadResponse) {
