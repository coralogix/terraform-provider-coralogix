...
func (p *coralogixProvider) DataSources(context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		dataplans.NewTCOPoliciesRumDataSource,
		dataplans.NewQuotaAllocationRuleSetDataSource,
