			...
			"config": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					"all_region_config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Take the geographic information from a region field whose values may come from any supported cloud provider. This is a preview alternative.",
					},
					...
					"ibm_region_config": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Take the geographic information from an IBM Cloud region field in the query results. This is a preview alternative.",
					},
				},
				Validators: []validator.Object{
...
// The arm itself carries the selection, so a selected arm with no region field
// must read back present with a null child rather than as an absent arm.
