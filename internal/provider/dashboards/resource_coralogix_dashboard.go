...
func flattenHorizontalBarChartQueryMetrics(ctx context.Context, metrics *dashboardservice.HorizontalBarChartMetricsQuery) (*dashboardwidgets.HorizontalBarChartQueryModel, diag.Diagnostics) {
	...
	flattenedMetrics := &dashboardwidgets.BarChartQueryMetricsModel{
		...
		Aggregation:      dashboardwidgets.FlattenEnum(metrics.GetAggregation(), dashboardwidgets.DashboardProtoToSchemaCommonAggregation),
		EditorMode:       dashboardwidgets.FlattenEnum(metrics.GetEditorMode(), dashboardwidgets.DashboardProtoToSchemaMetricsEditorMode),
		PromqlQueryType:  dashboardwidgets.FlattenEnum(metrics.GetPromqlQueryType(), dashboardwidgets.DashboardProtoToSchemaPromQLQueryType),
		TimeFrame:        timeFrame,
	}
...
func flattenBarChart(ctx context.Context, barChart *dashboardservice.BarChart) (*dashboardwidgets.WidgetDefinitionModel, diag.Diagnostics) {
	...
	return &dashboardwidgets.WidgetDefinitionModel{
		BarChart: &dashboardwidgets.BarChartModel{
			...
			BarValueDisplay:   dashboardwidgets.FlattenEnum(barChart.GetBarValueDisplay(), dashboardwidgets.DashboardProtoToSchemaBarValueDisplay),
			...
			XAxisTimeFormat:   dashboardwidgets.FlattenEnum(barChart.GetXAxisTimeFormat(), dashboardwidgets.DashboardProtoToSchemaXAxisTimeFormat),
